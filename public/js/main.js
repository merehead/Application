$(document).ready(function () {
    ...
    //-- for Carier Profiles --------
    $('.carer-profile').find('select').attr("disabled", true).addClass('profileField__select--greyBg');
    $('.carer-profile').find('input').attr("readonly", true).addClass('profileField__input--greyBg');
