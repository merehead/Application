        ...
        <div class="container">
            <div class="faqContainer">
                <div class="faq faq--active">
                    ...
                    <div class="faq__content">
                        <p>
                            ...
                            tight control over their staff. We impose no restrictions over carers. We simply expect them
                            to offer great care and make sure that people are happy and safe.
                        </p>
                ...
                <div class="faq faq--active">
                    ...
                    <div class="faq__content">
                        <p>
                            ...
                            carers, contract with them securely. Holm helps you find quality carers in your area and
                            then contact them directly. You can do this by searching for carers using your postcode and
                            filtering system, to make sure you find the carers you need. You can then book and
                            communicate with them through our site. The Carer will then confirm the appointment, or
                            possibly offer alternatives if they’re busy. The carer will receive all the information they
                            need to help before coming to your home.
                        </p>
                    </div>
                </div>
                ...
                <i class="fa fa-plus toggler"></i>
                    ...
                    <div class="faq__content">
                        <p>
                            Naturally. Carers can’t always be available when you need them. Sometimes having two people
                            help at the same time can also be a good idea. By using multiple carers, you can ensure you
                            receive great care whenever needed. It also means that you’ll have other trusted carers to
                            rely on if one decides they deserve a well earned break! You can manage all your bookings
                ...
                <i class="fa fa-plus toggler"></i>
                    ...
                    <div class="faq__content">
                        <p>
                            ...
                            circumstances such as emergency medical treatment. Please do contact us if you need help. In
                            the event of a whole booking being cancelled, we may contact you to see how we can help, and
                            to arrange any reimbursements.
                        </p>
                    </div>
                ...
                <i class="fa fa-plus toggler"></i>
                    ...
                    <div class="faq__content">
                        <p>
                            ...
                            was completed successfully. The Carer is then paid the following Friday. If you have made an
                            ongoing booking of appointments, then the carer will be paid after the successful completion
                            of each appointment, rather than the completion of the whole booking.
                        </p>
                    </div>
                ...
                <i class="fa fa-plus toggler"></i>
                    ...
                    <div class="faq__content">
                        <p>
                            No. Holm’s service is carefully balanced to ensure a quality service for everyone, and make
                ...
                <i class="fa fa-plus toggler"></i>
                    ...
                    <div class="faq__content">
                        ...
                        <p>
                            ...
                            need to cancel any ongoing bookings, and whether you should be reimbursed for poor service.
                            It is just as important that good care is rewarded, as poor care isn’t.
                        </p>
                    </div>
                ...
                <i class="fa fa-plus toggler"></i>
                    ...
                    <div class="faq__content">
                        <p>
                            ...
                            to register with the Care Quality Commission (CQC). Individual self-employed carers do not
                            have to register with CQC either. We do however want to ensure the highest levels of care,
                            and continuously use your feedback so that only the best carers are available on Holm.
                        </p>
                        <!-- <p>
