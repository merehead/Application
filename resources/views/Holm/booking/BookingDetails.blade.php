                    ...
                    <div class="col-md-3">
                        <div class="app-btn">
                            @if($user->user_type_id !== 4)
                                ...
                                <button data-appointment_id="{{$appointment->id}}" {{$booking->status_id != 5 || !in_array($appointment->{$field}, [1])  ? 'disabled' : ''}}  data-appointment_id = "{{$appointment->id}}" data-status = "reject"  class="changeAppointmentStatus app-btn__item">
