        ...
        <div class="message">
              ...
              <span class="ordinaryTitle__text ordinaryTitle__text--smaller">
                ...
                <div class="messageGroup ">
                    ...
                    <div class="messageCheckbox checktime">
                        <div class="checkBox_item">
                            <input type="checkbox" name="checkbox" class="customCheckbox" id="boxD1">
                            <label for="boxD1">Daily</label>
                        </div>
                        <div class="checkBox_item">
                            <input type="checkbox" name="checkbox" class="customCheckbox" id="boxD2">
            ...
            <div class="message__footer">
                ...
                <div class="messageTotal">
                    <div class="bookBtn">
                        <a href="Checkout_for_Purchaser__CARD.html"
