            ...
            <div class="orderInfo">
                ...
                <div class="orderInfo__item orderInfo__item--rightPadding">
                    <h2 class="ordinaryTitle">
                        <span class="ordinaryTitle__text ordinaryTitle__text--bigger"><a href="Service_user_Public_profile_page.html">   Bob M.</a></span>
                    </h2>
                ...
                <div class="orderInfo__item ">
                    ...
                    <!--           <div class="orderOptions">
                                 <h2 class="ordinaryTitle">
                                   <span class="ordinaryTitle__text ordinaryTitle__text--bigger">How often</span>
                                 </h2>
                                 <span class="orderOptions__value">Daily </span>
                               </div>
                   -->
        ...
        <div class="bookingRow bookingRow--moreMargin">
            <div class="bookingRow__content">
                ...
                <div class="careRequested">
                    ...
                    <div class="careRequested__item">
                        <p>DRESSINGS AND WOUND MANAGEMENT </p>
                        <p>HOUSEKEEPING</p>
                    </div>
