...
<div class="borderContainer">
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} DEMENTIA</span></h2>
...
<div class="borderContainer">
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} problems understanding other people</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} difficulties understanding or  communicating with other</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
{{--        <div class="profileField profileField--two-thirds"{!!  ($serviceUsersProfile->communication == 'No' || is_null($serviceUsersProfile->communication) )? ' style="display:none"' : ''!!}>
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}} help with speech</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} serious impediments seeing</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} serious impediments hearing</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
<div class="borderContainer">
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} allergies to food / medication / anything else</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
<div class="borderContainer">
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} risk of developing pressure sores on their skin</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}} assistance with changing wound dressings</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
<div class="borderContainer">
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Require':'Requires'}} help with mobility</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}}  help moving around home</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}} help getting in / out of bed</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}}   a history of falls</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}}  help going shopping, or to other local facilities / events</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
<div class="borderContainer">
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Require':'Requires'}}  assistance with eating / drinking</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">Can prepare food for {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'yourself':'themselves'}}</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
{{--        <div class="profileField profileField--two-thirds"{!!  ($serviceUsersProfile->prepare_food == 'No' || is_null($serviceUsersProfile->prepare_food) )? ' style="display:none"' : ''!!}>
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} any preferences of food? eg. Are there any do's and don'ts?</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
{{--        <div class="profileField profileField--two-thirds"{!!  ($serviceUsersProfile->assistance_with_preparing_food == 'No' || is_null($serviceUsersProfile->assistance_with_preparing_food) )? ' style="display:none"' : ''!!}>
        ...
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle">
              <span class="ordinaryTitle__text ordinaryTitle__text--smaller">
               {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} special nutritional or belief based dietary requirements
              </span>
            </h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} other special dietary requirements</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
<div class="borderContainer">
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Require':'Requires'}} assistance in getting dressed / bathing or toileting</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}} assistance in choosing appropriate clothes</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
...
{{--        <div class="profileField profileField--two-thirds"{!!  ($serviceUsersProfile->appropriate_clothes == 'No' || is_null($serviceUsersProfile->appropriate_clothes) )? ' style="display:none"' : ''!!}>
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}} assistance getting dressed / undressed</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}} assistance with bathing / showering</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}}   assistance managing their toilet needs</span></h2>
    ...
    <div class="profileRow depend_from_managing_toilet_needs" {!!  ($serviceUsersProfile->managing_toilet_needs != 'Yes' || is_null($serviceUsersProfile->managing_toilet_needs) )? ' style="display:none"' : ''!!} >
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}}  help mobilising themselves to the toilet</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow depend_from_managing_toilet_needs" {!!  ($serviceUsersProfile->managing_toilet_needs != 'Yes' || is_null($serviceUsersProfile->managing_toilet_needs) )? ' style="display:none"' : ''!!} >
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}}  help cleaning themselves when using the toilet</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
    ...
    <div class="profileRow">
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} incontinence</span></h2>
    ...
    <div class="profileRow depend_from_have_incontinence" {!!  ($serviceUsersProfile->have_incontinence != 'Yes' || is_null($serviceUsersProfile->have_incontinence) )? ' style="display:none"' : ''!!}>
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Have':'Has'}} own supply of incontinence wear</span></h2>
    ...
    || $serviceUsersProfile->have_incontinence != 'Yes' || is_null($serviceUsersProfile->have_incontinence) )? ' style="display:none"' : ''!!}>
        <div class="profileField">
            <h2 class="profileField__title ordinaryTitle"><span class="ordinaryTitle__text ordinaryTitle__text--smaller">{{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Need':'Needs'}}  help in choosing incontinence products</span></h2>
            <?php if (isset($atrr)) unset($atrr); $atrr = ['class' => 'profileField__select serviceUserProfile'];
