@include(config('settings.frontTheme').'.serviceUserProfiles.Booking.BookingTabHeader')
        <div class="justifyContainer justifyContainer--smColumn">
            <div class="bookingNav">
                <a href="/serviceUser-settings/booking/{{$serviceUsersProfile->id}}/all" class="bookingNav__link centeredLink">
            <span class="bookingNav__text">
              ALL
            </span>
                </a>
                <a href="/serviceUser-settings/booking/{{$serviceUsersProfile->id}}/new" class="bookingNav__link centeredLink">
            <span class="bookingNav__text">
              new
            </span>
                </a>
                <a href="/serviceUser-settings/booking/{{$serviceUsersProfile->id}}/progress" class="bookingNav__link centeredLink">
            <span class="bookingNav__text">
              in progress
            </span>
                </a>
                <a href="/serviceUser-settings/booking/{{$serviceUsersProfile->id}}/completed" class="bookingNav__link centeredLink">
            <span class="bookingNav__text">
              completed
            </span>
                </a>
