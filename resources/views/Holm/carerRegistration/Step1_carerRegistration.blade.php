<div class="registration">
    <div class="registration__column registration__column--with-padding">
        ...
        {!! Form::open(['method'=>'POST','route'=>'CarerRegistrationPost','id'=>'step','class'=>'registrationForm']) !!}
...
//                    <input type="text" name="referral_code" {{(!empty($ref_code))? 'value ="'.$ref_code.'"' : 'value ="'.old('referral_code').'"' }}
        ...
        <div class="formField">
            ...
            <label for="confirm-terms">I accept Holm’s <a href="{{route('TermsPage')}}" target="_blank">Terms & Conditions</a> and <a href="{{route('privacy_policy')}}" target="_blank">privacy policy</a></label>
