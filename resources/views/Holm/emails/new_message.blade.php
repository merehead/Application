...
<h1 style=" font-size: 16px;display: inline-block;font-family: 'Lato', sans-serif; margin-bottom: 20px; font-weight: 700; color: #272c2b;  text-transform: uppercase;">
    Hi, {{($sender=='carer')?$server_users->short_full_name:$carer->short_name}}!
</h1>
<p>
    @if($sender=='carer')
        You have a new message from {{$carer->short_name}} in regards to a
        <a href="{{route('viewBookingDetails',['booking'=>$booking])}}">booking</a>.
    @else
            ...
            <table cellpadding="0" cellspacing="0" border="0"  style=" border-collapse: collapse;background-size: 100%;   margin: 0; padding: 10px 30px;" width="100%" class="content">
                <tr>
                    <td style="padding-left: 40px;" align="left"  valign="middle">
                        <img src="images/logo.png" alt="" class="logo"  style="width: 120px; float: left; "  >

                    </td>
                    <td style="padding-left: 30px;">
                        <img src="images/l1.png" alt="" class=""  style="width:  100% ; float: right; "  >
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 30px 40px; background: #f9f9f9; font-family: 'Roboto', sans-serif; line-height: 1.5; "  valign="top" class="">
                        <h1 style="display: inline-block;font-family: 'Lato', sans-serif; margin-bottom: 20px; font-weight: 700; font-size: 16px; color: #272c2b;  text-transform: uppercase;">
                            Hello, {{($sender=='carer')?$server_users->short_full_name:$carer->short_name}}!
                        </h1>
        ...
        <table cellpadding="0" cellspacing="0" border="0"  style="    margin: 0; " width="100%"  class="t-content">
            ...
            <tr>
                <td style="padding:  0 40px 30px 40px; background: #fff; "  valign="top" class="">
                    <p
                            style="max-width: 600px;font-size: 15px; color: #373f3e;line-height: 1.6;">
                ...
                <td style="padding: 0 40px 30px 0; background: #fff; "  valign="top" class="">
