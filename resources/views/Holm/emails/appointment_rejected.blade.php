                ...
                <tr>
                    <td style="padding: 30px 40px; color:#272c2b;background: #f9f9f9; " valign="top" class="">
                        ...
                        <p style=" text-align: justify; font-weight: 300; margin: 10px 0;">
                            ...
                            @endif
                            has rejected  <a href="{{route('viewBookingDetails',[$booking->id])}}?refer={{$booking->id}}">appointment</a> on  {{$appointment->formatted_date_start}} at {{$appointment->formatted_time_from}}.<br/></p>
                    </td>
                </tr>
            </table>
        </td>
