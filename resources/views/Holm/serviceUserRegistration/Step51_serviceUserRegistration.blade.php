        ...
        <div class="personal">
            ...
            <div class="formField">
                    <h2 class="formLabel questionForm__label">
                        {{($serviceUserProfile->care_for=='Myself')?'Do you':'Does '.$userNameForSite}}  have a doctor's note or court order saying that   {{($serviceUserProfile->care_for=='Myself')?'you':'they'}} are not able to give consent? <span>*</span>
                    </h2>
                    <div class="inputWrap">
                        <?php
