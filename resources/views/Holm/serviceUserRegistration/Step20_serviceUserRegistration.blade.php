            ...
            {!! Form::model($serviceUserProfile,['method'=>'POST','action'=>['ServiceUserRegistrationController@update',$serviceUserProfileID],'id'=>'step','class'=>'questionForm']) !!}
                ...
                <div class="formField">
                    <h2 class="formLabel questionForm__label">
                        {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Do you':'Does '.$userNameForSite}} have a history of falls? - i.e. falls more than once a week, or  {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'have':'has'}} been in hospital as a consequence of a fall.  <span>*</span>
                ...
                <div class="formField sometimes_hiding" style="display: none">
                    ...
                    <div class="inputWrap">
                        {!! Form::textarea('falls_detail',null,['class'=>'formArea ','placeholder'=>'Details','maxlength'=>"500"]) !!}
