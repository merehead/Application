        ...
        <div class="personal">
            ...
            <div class="formField">
                    <h2 class="formLabel questionForm__label">
                        {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Do you':'Does '.$userNameForSite}}  need help going shopping, or to other local facilities / events? <span>*</span>
                    </h2>
                    <div class="inputWrap">
                        <?php
