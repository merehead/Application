    ...
    <div class="registration__column registration__column--with-padding">
        <div class="questionsBox">
            ...
            <div class="questionsBox__img">
                <img src="{{asset('/img/Signup_P_step17.jpg')}}./dist/img/Signup_P_step28.jpg" alt="">
            </div>
            ...
            <form class="questionForm">
                ...
                <div class="formField">
                    <h2 class="formLabel questionForm__label">
                        Does [Service_user_name] sometimes have problems understanding other people? <span>*</span>       </h2>
                    <div class="inputWrap">
