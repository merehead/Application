    ...
    <div class="registration__full">
        ...
        <div class="sorryBox">
            <p class="info-p info-p--roboto">
                We are now going to ask some questions about {{(App\ServiceUsersProfile::find($serviceUserProfileID)->purchaser->purchasing_care_for=='Myself')?'your':$serviceUserProfile->like_name."'s"}}  health.
