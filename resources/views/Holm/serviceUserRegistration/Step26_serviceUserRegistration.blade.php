        ...
        <div class="personal">
            ...
            <div class="formField">
                    <h2 class="formLabel questionForm__label">
                        {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Do you':'Does '.$userNameForSite}}  have serious impediments hearing? <span>*</span>         </h2>
                    <div class="inputWrap">
                        <?php
            ...
            <div class="formField sometimes_hiding" style="display: none">
                    ...
                    <div class="inputWrap">
                        {!! Form::textarea('hearing_detail',null,['class'=>'formArea ','placeholder'=>'Details','maxlength'=>"500"]) !!}
