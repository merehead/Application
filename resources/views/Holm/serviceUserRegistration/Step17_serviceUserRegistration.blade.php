<div class="registration">
    <div class="registration__column registration__column--with-padding">
        <div class="questionsBox">
            <h2>{{($serviceUserProfile->care_for=='Myself')?'Your':$userNameForSite."'s"}} Health</h2>
        ...
        <div class="personal">
            ...
            <div class="formField">
                <h2 class="formLabel questionForm__label">
                    {{($serviceUserProfile->care_for=='Myself')?'Do you':'Does '.$userNameForSite}} have any of the following conditions?
                </h2>
                <div class="inputWrap">
