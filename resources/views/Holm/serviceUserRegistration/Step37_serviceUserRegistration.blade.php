        ...
        <div class="personal">
            ...
            <div class="formField">
                <h2 class="formLabel questionForm__label">
                    {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Do you':'Does '.$userNameForSite}}  have any food / drink allergies? <span>*</span>
                </h2>
                <div class="inputWrap">
                    <?php
                    if (isset($atrr)) unset($atrr);
                    $atrr = ['id' => 'sometimes-if', 'class' => 'formSelect'];
                    if (is_null($serviceUserProfile->food_allergies))
                        $atrr['placeholder'] = 'Please select';
                    ?>
                    {!! Form::select('food_allergies',['Yes'=>'Yes','No'=>'No'],null,$atrr) !!}
            ...
            <div class="formField sometimes_hiding" style="display: none">
                ...
                <div class="inputWrap">
                    {!! Form::textarea('food_allergies_detail',null,['class'=>'formArea ','placeholder'=>'Detail','maxlength'=>"250"]) !!}
