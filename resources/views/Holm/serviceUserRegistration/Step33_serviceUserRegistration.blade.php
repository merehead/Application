        ...
        <div class="personal">
            ...
            <div class="formField">
                    <h2 class="formLabel questionForm__label">
                        {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Do you':'Does '.$userNameForSite}}  require any assistance in taking medication / treatments? <span>*</span>
                    </h2>
                    <div class="inputWrap">
                        <?php
            ...
            <div class="formField sometimes_hiding" style="display: none">
                    ...
                    <div class="inputWrap">
                        {!! Form::textarea('in_medication_detail',null,['class'=>'formArea ','placeholder'=>'Detail','maxlength'=>"500"]) !!}
