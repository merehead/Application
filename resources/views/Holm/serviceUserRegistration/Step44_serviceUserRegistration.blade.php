        ...
        <div class="personal">
            ...
            <div class="formField">
                    <h2 class="formLabel questionForm__label">
                        {{($serviceUserProfile->care_for=='Myself')?'Do you':'Does '.$userNameForSite}}  need assistance in choosing appropriate clothes? - eg choosing warm clothes in the winter. <span>*</span>
                    </h2>
                    <div class="inputWrap">
                        <?php
