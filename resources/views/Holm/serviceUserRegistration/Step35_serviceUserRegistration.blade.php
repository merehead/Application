        ...
        <div class="personal">
            ...
            <div class="formField">
                    <h2 class="formLabel questionForm__label">
                        {{($serviceUserProfile->purchaser->purchasing_care_for=='Myself')?'Do you':'Does '.$userNameForSite}}  need assistance with changing wound dressings?  <span>*</span>
                    </h2>
                    <div class="inputWrap">
                        <?php
            ...
            <div class="formField sometimes_hiding" style="display: none">
                    ...
                    <div class="inputWrap">
                        {!! Form::textarea('dressings_detail',null,['class'=>'formArea ','placeholder'=>'Detail','maxlength'=>"500"]) !!}
