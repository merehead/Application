        ...
        @if(count($user->userPurchaser))
            <table class="innerTable ">
                @foreach($user->userPurchaser as $item)
                    <tr>
                        <td class="nameField">
                            <span>{{$item->amount_for_purchaser}}</span>
                        </td>
                        ...
                        @else
                            ...
                            <td class="nameField">
                                <div class="actionsGroup">
                                    <a href="{{route('BookingPayoutToPurchaser',['pay',$item->id,$item->amount_for_purchaser])}}"
                                       class="actionsBtn actionsBtn--accept">
                                        payout bookings
                                    </a>
                                    <a href="{{route('BookingPayoutToPurchaser',['cancel',$item->id,$item->amount_for_purchaser])}}"
                                       class="actionsBtn actionsBtn--reject">
                                        cancel booking
                                    </a>
                                    <a href="{{route('BookingPayoutToPurchaser',['delay',$item->id,$item->amount_for_purchaser])}}"
                                       class="actionsBtn actionsBtn--accept">
                                        delay booking
                                    </a>
